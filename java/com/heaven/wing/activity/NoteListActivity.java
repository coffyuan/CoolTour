...
public class NoteListActivity extends AppCompatActivity implements View.OnClickListener,NoteAdapter.OnItemClickListener {
        ...
        query.findObjects(new FindListener<Note>() {
            ...
            public void done(List<Note> list, BmobException e) {
                if(e==null){
                    ...
                    DividerItemDecoration itemDecorationHeader = new DividerItemDecoration(NoteListActivity.this, DividerItemDecoration.VERTICAL_LIST);//RecyclerView的通用间隔条(vivider)
                    itemDecorationHeader.setDividerDrawable(ContextCompat.getDrawable(NoteListActivity.this, R.drawable.divider_main_bg_height_1));
                    myAdapter = new NoteAdapter(NoteListActivity.this,list);
                        ...
                        note1.delete(new UpdateListener() {
                            ...
                            public void done(BmobException e) {
                                if(e==null){
                                    ...
                                    Toast.makeText(NoteListActivity.this,"删除失败",Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                        index--;
